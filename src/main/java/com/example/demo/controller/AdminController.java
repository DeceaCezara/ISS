...
import com.example.demo.model.dtos.WorkerDto;
...
public class AdminController implements Controller {
    ...
    public void createWorkerClicked() throws IOException {
        ...
        Controller ctrl = Functions.fxmlLoad(stage, "/gui/worker-details.fxml");
    ...
    public void assignTaskClicked() throws IOException {
        ...
        Controller ctrl = Functions.fxmlLoad(stage, "/gui/task-details.fxml");
        ctrl.setService(service);
